...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    <applicationVisibilities>
        <application>Velostrata_Service_Cloud</application>
        <default>false</default>
        <visible>true</visible>
    </applicationVisibilities>
    <applicationVisibilities>
        <application>Velostrata_Service_Cloud_Lightning</application>
        <default>false</default>
    ...
    <layoutAssignments>
        <layout>Case-Case Layout</layout>
        <recordType>Case.Velostrata</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Case-Case Layout</layout>
        <recordType>Case.Workbench</recordType>
    </layoutAssignments>
    <layoutAssignments>
